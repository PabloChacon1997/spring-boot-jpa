...
public class ClienteController {
	...
	public String ver(@PathVariable(value = "id") Long id, Map<String, Object> model, RedirectAttributes flash, Locale locale) {
		...
		Cliente cliente = clienteService.fetchByIdWithCliente(id); // clienteService.findOne(id);
		if (cliente == null) {
	...
	public String listar(@RequestParam(name = "page", defaultValue = "0") int page, Model model,
		...
		if (authentication != null) {
			logger.info(messageSource.getMessage("text.login.success", null, locale).concat(authentication.getName()));
		}
		...
		if (auth != null) {
			logger.info(
					"Utilizando de forma estatica SecurityContextHolder.getContext().getAuthentication(). Hola usuario autenticado, tu nombre es: "
							.concat(auth.getName()));
		}
	...
	public String crear(Map<String, Object> model, Locale locale) {
		...
		model.put("boton", messageSource.getMessage("text.cliente.form.titulo.crear", null, locale));
	...
	public String editar(@PathVariable(name = "id") Long id, Map<String, Object> model, RedirectAttributes flash, Locale locale) {
		...
		model.put("boton", messageSource.getMessage("text.cliente.form.titulo.editar", null, locale));
		return "form";
	}
	...
	private boolean hasRole(String role) {
		 ...
		 * ".concat(auth.getName()).concat(" tu role es:
