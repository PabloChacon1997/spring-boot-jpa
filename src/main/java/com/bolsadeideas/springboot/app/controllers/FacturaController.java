...
public class FacturaController {
	...
	public String ver(@PathVariable(value = "id") Long id,
		...
		Factura factura = clienteService.fecthFacturaByIdWhithClienteWithItemFacturaWithProducto(id); //clienteService.findFacturaById(id);
		if (factura == null) {
	...
	public String guardar(@Valid Factura factura,
		...
		for (int i = 0; i < item_id.length; i++) {
			Producto producto = clienteService.findProductoById(item_id[i]);
